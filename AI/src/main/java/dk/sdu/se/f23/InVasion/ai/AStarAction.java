...
public class AStarAction implements ActionService {
    ...
    public AStarAction(int rows, int cols, Node initialNode, Node finalNode, int hvCost, int diagonalCost) {
        this.hvCost = hvCost;
    ...
    public AStarAction(int rows, int cols, Node initialNode, Node finalNode) {
